...
const DEFAULT_API_KEY = '8ba50f3775f004dc011c39700a4f0a16';
...
export class LiveSportsService {
  ...
  public static getApiKey(): string {
    if (typeof window !== 'undefined') {
      ...
      // Auto-migrate if user had other keys saved in browser localStorage
      if (stored === 'c6cc5131f2e2954832edba4a8620877e' || stored === '0c6133a9999fc461ae990c6dbaa55579') {
